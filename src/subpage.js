...
const pages = {
  ...
  about: {
    eyebrow: 'About Oluwa', title: 'Many hands.\nOne direction.', intro: 'Oluwa Conglomerate is a family of businesses working across housing, textiles, and food to make everyday life more considered and more connected.', color: 'about', stat: '25+', statLabel: 'years of building', detailTitle: 'We stay close to the work.', detail: 'Our teams are practical optimists. We listen to communities, learn from the details, and measure success by what lasts after we leave.'
  },
  journal: {
...
document.querySelector('#app').innerHTML = `
  ...
  <footer class="site-footer"><div class="section-shell footer-inner"><a class="brand" href="index.html"><span class="brand-mark">O</span><span>OLUWA <b>CONGLOMERATE</b></span></a><div class="footer-links"><a href="about.html">About us</a><a href="journal.html">Journal</a><a href="contact.html">Contact</a></div><p>© 2025 Oluwa Conglomerate</p></div></footer>
`
