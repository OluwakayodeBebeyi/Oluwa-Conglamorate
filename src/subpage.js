...
document.querySelector('#app').innerHTML = `
  ...
  <main class="subpage ${current.color}">
    <section class="sub-hero section-shell"><div><p class="eyebrow"><span></span> ${current.eyebrow}</p><h1>${current.title.replace('\n', '<br>')}</h1><p class="hero-intro">${current.intro}</p><a class="text-link" href="contact.html">Start a conversation <span>↗</span></a></div><div class="sub-art"><div class="sub-art-shape"><img src="/oc-logo.png" alt="Oluwa Conglomerate OC logo"></div><span class="sub-art-label">${current.eyebrow}<br><strong>Since 2025</strong></span></div></section>
    ...
    ${catalogMarkup}
    ${page === 'journal' ? '<section class="sub-stories section-shell"><a id="food-story" class="story-card" href="foods.html"><article><div class="story-image story-one"><span>FIELD NOTES / 01</span></div><p class="story-meta">Oluwa Foods · 06.12.24</p><h3>Why the best meals begin long before the kitchen.</h3></article></a><a id="housing-story" class="story-card" href="housing.html"><article><div class="story-image story-two"><span>FIELD NOTES / 02</span></div><p class="story-meta">Oluwa Housing · 18.10.24</p><h3>A home is more than four walls. We know.</h3></article></a><a class="story-card" href="textiles.html"><article><div class="story-image story-three"><span>FIELD NOTES / 03</span></div><p class="story-meta">Oluwa Textiles · 02.09.24</p><h3>What makes a fabric feel like it belongs.</h3></article></a></section>' : ''}
