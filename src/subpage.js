...
document.querySelector('#app').innerHTML = `
  ...
  <footer class="site-footer"><div class="section-shell footer-main"><div class="footer-intro"><a class="brand" href="index.html"><img class="brand-logo" src="/oc-logo.png" alt="Oluwa Conglomerate logo"><span class="brand-name">OLUWA <b>CONGLOMERATE</b></span></a><p>Better essentials, made accessible.<br>For everyone, for the long run.</p></div><div class="footer-column"><p class="footer-label">Divisions</p><a href="foods.html">Oluwa Foods and Organics</a><a href="textiles.html">Oluwa Clothing and Textiles</a><a href="housing.html">Oluwa Housing & Estate</a></div><div class="footer-column"><p class="footer-label">Company</p><a href="about.html">Our story</a><a href="journal.html">Journal</a><a href="contact.html">Contact us</a></div><div class="footer-column"><p class="footer-label">Visit</p><p>Lagos, Nigeria</p><a href="mailto:hello@oluwaconglomerate.com">hello@oluwaconglomerate.com</a><a href="tel:+2348000000000">+234 800 000 0000</a></div></div><div class="section-shell footer-bottom"><p>© 2025 Oluwa Conglomerate</p><p>Food · Clothing · Shelter</p><a href="index.html">Back to home ↑</a></div></footer>
`
