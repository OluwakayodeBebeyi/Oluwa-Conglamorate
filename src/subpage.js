...
document.querySelector('#app').innerHTML = `
  <header class="site-header"><a class="brand" href="index.html" aria-label="Oluwa Conglomerate home"><img class="brand-logo" src="/oc-logo.png" alt="Oluwa Conglomerate logo"><span class="brand-name">OLUWA <b>CONGLOMERATE</b></span></a><button class="menu-toggle" type="button" aria-expanded="false" aria-controls="site-nav">Menu <span>+</span></button><nav id="site-nav" class="site-nav" aria-label="Main navigation"><details class="nav-divisions"><summary>Our divisions</summary><div class="nav-dropdown"><a href="foods.html">Oluwa Foods and Organics</a><a href="textiles.html">Oluwa Clothing and Textiles</a><a href="housing.html">Oluwa Housing &amp; Estate</a></div></details><a href="about.html">Our approach</a><a href="journal.html">Journal</a><a class="nav-cta" href="contact.html">Work with us <span>↗</span></a></nav></header>
