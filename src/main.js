...
document.querySelector('#app').innerHTML = `
  ...
  <footer class="site-footer"><div class="section-shell footer-inner"><a class="brand" href="index.html"><img class="brand-logo" src="/oc-logo.png" alt=""><span>OLUWA <b>CONGLOMERATE</b></span></a><div class="footer-links"><a href="#divisions">Divisions</a><a href="about.html">About us</a><a href="journal.html">Journal</a><a href="contact.html">Contact</a></div><p>© 2025 Oluwa Conglomerate</p></div></footer>
`
